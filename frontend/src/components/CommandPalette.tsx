...
export function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const items: CommandItem[] = useMemo(
    () => [
      // Navigation
      { id: "nav-overview", label: "Overview", icon: LayoutGrid, section: "Navigation", action: () => go("/"), keywords: ["home", "dashboard"] },
      { id: "nav-providers", label: "Providers", icon: Boxes, section: "Navigation", action: () => go("/providers"), keywords: ["accounts", "openai", "anthropic"] },
      { id: "nav-endpoints", label: "Endpoints", icon: Network, section: "Navigation", action: () => go("/endpoints"), keywords: ["proxy", "settings"] },
      { id: "nav-chains", label: "Combos", icon: Layers, section: "Navigation", action: () => go("/chains"), keywords: ["chain", "routing", "fallback"] },
      { id: "nav-usage", label: "Usage", icon: BarChart3, section: "Navigation", action: () => go("/usage"), keywords: ["analytics", "stats", "tokens"] },
      { id: "nav-quota", label: "Quota Tracker", icon: Clock, section: "Navigation", action: () => go("/quota"), keywords: ["limits", "upstream"] },
      { id: "nav-cli-tools", label: "CLI Tools", icon: TerminalSquare, section: "Navigation", action: () => go("/cli-tools"), keywords: ["claude", "codex", "cline", "copilot"] },
      { id: "nav-media", label: "Media Providers", icon: Image, section: "Navigation", action: () => go("/media"), keywords: ["image", "video", "tts", "stt"] },
      { id: "nav-proxy-pools", label: "Proxy Pools", icon: Waypoints, section: "Navigation", action: () => go("/proxy-pools"), keywords: ["proxy", "residential", "egress"] },
      { id: "nav-skills", label: "Skills", icon: Sparkles, section: "Navigation", action: () => go("/skills"), keywords: ["prompt", "custom"] },
      { id: "nav-console", label: "Console Log", icon: ScrollText, section: "Navigation", action: () => go("/console"), keywords: ["logs", "debug", "output"] },
      { id: "nav-keys", label: "API Keys", icon: Key, section: "Navigation", action: () => go("/keys"), keywords: ["auth", "token", "secret"] },
      { id: "nav-budgets", label: "Budgets", icon: Wallet, section: "Navigation", action: () => go("/budgets"), keywords: ["cost", "limit", "spend"] },
      { id: "nav-settings", label: "Token Saving", icon: Zap, section: "Navigation", action: () => go("/settings"), keywords: ["rtk", "caveman", "terse", "cache"] },
