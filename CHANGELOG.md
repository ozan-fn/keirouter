...
- **connectors:** Reject non-JSON upstream responses(f298773)
- **qoder:** Preserve tool history integrity(b208976)


### Documentation

- Update CHANGELOG.md and VERSION for v0.1.26(7730d26)


### Features

- **admin:** Improve provider usage and API key UX(a4e0a93)
- **kiro:** Add response integrity gate with auto-retry(e3308ab)
- **kiro:** Persist conversationId per session for context continuity(2c12517)


### Testing

- **kiro:** Enhance event stream parser and tool use validation tests(8be3a4c)
