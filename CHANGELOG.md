...
- Update CHANGELOG.md and VERSION for v0.1.27(5f6b647)


### Features

- **gateway:** Auto-prefix kiro models(f6b1a07)
- **pricing:** Backfill legacy unpriced usage rows and merge custom model prices(4c015f6)
- **anthropic:** Add support for signature deltas and thinking blocks in streaming(4d7e168)


### Refactor

- **kiro:** Remove kr/ prefix handling(b545570)
...
- Update CHANGELOG.md and VERSION for v0.1.26(47330e7)


### Features

- **core:** Upgrade Go runtime, add PostgreSQL integration, enhance cache and database configuration(7771513)
- **transform:** Support thinking_mode tag(cdfba23)


### Refactor

- **kiro:** Strip kr/ prefix from model(b9a8955)
